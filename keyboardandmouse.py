...
action_set = [move_forward,move_forward,move_backward,move_left,move_right,dodge,jump,light_attack,heavy_attack_0,heavy_attack_1,heavy_attack_2,heavy_attack_3]
action_size = len(action_set)

def take_action(action_idx):
    action_set[action_idx]()
    print("action:", action_set[action_idx].__name__)
